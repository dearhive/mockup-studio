...
dat.dom.dom = function (e) {
    ...
    var d = /(\d+(\.\d+)?)px/, f = {
        makeSelectable: function (b, a) {
            ...
            }, b.style.MozUserSelect = a ? "auto" : "none", b.style.KhtmlUserSelect =
...
dat.GUI = dat.gui.GUI = function (e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
    ...
    var w = "Default", u;
    try {
        u = false;//disabling localstorage for Chrome app//"localStorage"in window && window.localStorage !== null
    } catch (K) {
        u = false
    }
        ...
        Object.defineProperties(this, {
            parent: {
                ...
                get: function () {
                    ...
                    for (b = 0; b < this.__preset_select.length; b++)if (this.__preset_select[b].value == this.preset)this.__preset_select.selectedIndex =
                        b;
                    d.revert()
                }
            }, width: {
